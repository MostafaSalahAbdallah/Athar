        ...
        <div>
            <div className="dock" dir="rtl">
                ...
                <button >
                    ...
                    <span className="dock-label">المكتبة</span>
                </button>
                ...
                <button>
                    ...
                    <span className="dock-label">الأعدادات</span>
                </button>
            </div>
        </div>
    )
